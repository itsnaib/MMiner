...
This MetricMiner is framework of Java programming Language that helps developers to mine repositories easily. With it, you can easily obtain information from any git repositories such as commits,source codes and many others.
...
You simply have to start a Java Project in Eclipse. MetricMiner is on Maven, so you can download all its dependencies by only adding this to your pom.xml.:
...
public class MyStudy implements Study {
	...
	@Override
	public void execute() {
		// you can edit this part and remove the comment ;)
	}
}
```
